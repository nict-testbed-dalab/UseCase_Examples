...
//    'wni':{ type:'raster', path:'etc_2', group: 'ac_group2', name: '高解像度降水NC', layer: [] },
//    'amjp_veda02_sshfs_wnd':{ type:'raster', path:'etc_2', group: 'ac_group2', name: '風向・風速', layer: [] },
//    'amjp_veda02_sshfs_tsfc':{ type:'raster', path:'etc_2', group: 'ac_group2', name: '地表面気温', layer: [] },
//    'amjp_veda02_sshfs_rh.sfc':{ type:'raster', path:'etc_2', group: 'ac_group2', name: '地表面湿度', layer: [] },
